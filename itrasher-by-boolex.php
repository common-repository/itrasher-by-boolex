...
function register_itrasher_menu() {
	...
	add_menu_page( 'Image Trasher', 'iTrasher', 'manage_options', 'itrasher-by-boolex', 'itrasher_scan', plugins_url( 'itrasher-by-boolex/icon.png' ));
...
function ajax_itrasher_enqueue_scripts() {
    wp_enqueue_script( 'itrasher', plugins_url( 'itrasher-by-boolex/js/itrasher.js' ), array('jquery'), '1.0', true );
    wp_enqueue_style( 'itrasher', plugins_url( 'itrasher-by-boolex/css/itrasher.css' ) );
}
